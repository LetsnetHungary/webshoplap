        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="add-button-holder">
                    ...
                    <button id="blog_delete-button" style="width:300px; margin-bottom: 20px;" type="button" class="btn btn-danger">Törlés</button>
                </div>
            </div>
            <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="add-button-holder">
                    ...
                    <button id="shop_delete-button" style="width:300px; margin-bottom: 20px;" type="button" class="btn btn-danger">Törlés</button>
                </div>
            </div>
            <div class="col-xs-12">
